...
<img src="/assets/SrryStealerAnalysis/image10.png" style="width:6.5in;height:3.22222in" />
...
<img src="/assets/SrryStealerAnalysis/image8.png" style="width:6.5in;height:3.20833in" />
...
<img src="/assets/SrryStealerAnalysis/image20.png" style="width:9.05208in;height:7.19792in" />
...
<img src="/assets/SrryStealerAnalysis/image26.png" style="width:8.26042in;height:3.77083in" />

At the end of the section, I found the following code snippet:

<img src="/assets/SrryStealerAnalysis/image23.png" style="width:7.60417in;height:3.58333in" />
...
<img src="/assets/SrryStealerAnalysis/image19.png" style="width:6.95833in;height:2.95833in" />

VirusTotal also confirms that we can see that written MythicT24Setup exe
being created as a new process:

<img src="/assets/SrryStealerAnalysis/image13.png" style="width:7.01042in;height:4.89583in" />
...
<img src="/assets/SrryStealerAnalysis/image3.png" style="width:6.5in;height:4.77778in" />
...
<img src="/assets/SrryStealerAnalysis/image24.png" style="width:8.72917in;height:3.80208in" />
...
<img src="/assets/SrryStealerAnalysis/image4.png" style="width:11.72917in;height:6.1875in" />
...
<img src="/assets/SrryStealerAnalysis/image16.png" style="width:6.38542in;height:4.08333in" />
...
<img src="/assets/SrryStealerAnalysis/image15.png" style="width:16.89583in;height:4.9375in" />
...
<img src="/assets/SrryStealerAnalysis/image18.png" style="width:5.23958in;height:1.91667in" />

<img src="/assets/SrryStealerAnalysis/image25.png" style="width:2.71875in;height:2.72917in" />
...
<img src="/assets/SrryStealerAnalysis/image5.png" style="width:10.1875in;height:2.11458in" />

This revealed many DNS requests for the domain “linnisgood\[.\]site”,
which has detections on VirusTotal:

<img src="/assets/SrryStealerAnalysis/image11.png" style="width:7.66667in;height:3.28125in" />

However, this domain no longer appears to be active:

<img src="/assets/SrryStealerAnalysis/image27.png" style="width:18.9375in;height:5.85417in" />

However, for the following filters on procmon, nothing suspicious is
noticed:

<img src="/assets/SrryStealerAnalysis/image2.png" style="width:4.43229in;height:2.60946in" />
...
<img src="/assets/SrryStealerAnalysis/image6.png" style="width:8.15625in;height:1.54167in" />

<img src="/assets/SrryStealerAnalysis/image7.png" style="width:7.69792in;height:1.07292in" />
...
<img src="/assets/SrryStealerAnalysis/image9.png" style="width:8.38542in;height:3.38542in" />
...
<img src="/assets/SrryStealerAnalysis/image14.png" style="width:17.54167in;height:4.61458in" />
...
<img src="/assets/SrryStealerAnalysis/image21.png" style="width:6.5625in;height:3.125in" />

Looking in the results of the fakenet-ng logs, I don’t see any actual
HTTP/HTTPS
traffic.<img src="/assets/SrryStealerAnalysis/image12.png" style="width:15.98958in;height:3.5625in" />
...
<img src="/assets/SrryStealerAnalysis/image1.png" style="width:15.16667in;height:5.95833in" />
...
<img src="/assets/SrryStealerAnalysis/image17.png" style="width:20.17708in;height:8.21875in" />
